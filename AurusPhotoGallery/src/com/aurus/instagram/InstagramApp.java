...
import com.aurus.instagram.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
    ...
    /*
     * Initialize Instagram object
     * Initialize Token URL and Auth URL 
     */
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        mTokenUrl = Constant.TOKEN_URL + "?client_id=" + clientId + "&client_secret="
                + clientSecret + "&redirect_uri=" + mCallbackUrl
                + "&grant_type=authorization_code";
        mAuthUrl = Constant.AUTH_URL
                + "?client_id="
                + clientId
                + "&redirect_uri="
                + mCallbackUrl
    ...
    private void getAccessToken(final String code) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL(Constant.TOKEN_URL);
